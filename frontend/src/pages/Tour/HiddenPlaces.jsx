  ...
  return (
    ...
    <div class="mx-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 mt-10">
      <p class="uppercase text-5xl">
        get a brief about Hidden beauties in Rural Tourism
      </p>
      {/* <!-- first --> */}
      <div class="grid grid-cols-1 md:grid-cols-2 mt-10 gap-5">
        ...
        ></img>
        <div class="text-xl">
          <p className="font-extrabold text-2xl mb-3">Pune Lake</p>
          <p>
            pune Lake is a stunning man-made lake located in the hill country
            india, near the town of Elkaduwa in the Matale District. The lake is
            situated around 1,150 meters above sea level and is surrounded by
            lush green hills covered with tea plantations, eucalyptus trees, and
            dense forest. The Sembuwatta Lake was created by building a dam
            across the Sembuwatta River, which flows through a
