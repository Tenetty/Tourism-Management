...
const AddVehicle = () => {
  ...
  return (
    <div className="p-4 text-[#383838]  justify-center lg:px-96">
      <h1 className="text-lg lg:text-2xl font-bold py-6  text-center">
        Add a Vehicle
      </h1>
      <form onSubmit={sendData} encType="multipart/form-data">
        ...
        <input
          type="text"
          className="border rounded-lg w-full p-2 mb-6 mt-2"
        ...
        <br></br>
        <select
          className="p-2 border rounded-md w-full bg-white mt-2 mb-6"
          value={vehicleType}
        ...
        <datalist id="city">
          <option value="Colombo">Nashik</option>
          <option value="Galle">Pune</option>
          <option value="Kandy">Mumbai</option>
          <option value="Jaffna">Kolhapur</option>
          <option value="Matara">Matheran</option>
          <option value="Negombo">Saputara</option>
        </datalist>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between lg:my-6">
          ...
          <button
            className="bg-[#636363] text-white rounded-md font-bold p-3 lg:ml-6   w-full mb-12 lg:mb-0"
            type="reset"
          >
            Reset
          </button>
